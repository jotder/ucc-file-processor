 ...
 * {@link #catalog}, the {@link #reports} and {@link #statusStore} control-plane reads, the read-only
 * {@link #configs} seam (added M8 so {@code report-sql} can resolve a pipeline/job name to its config
 * for the operational-store query), the bundled {@link #docs} corpus, and the {@link #models} router.
