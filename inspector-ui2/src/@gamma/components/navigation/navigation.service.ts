...
export class GammaNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, GammaNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: GammaNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): GammaNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: GammaNavigationItem[],
        flatNavigation: GammaNavigationItem[] = []
    ): GammaNavigationItem[] {
    ...
    getItemParent(
        id: string,
        navigation: GammaNavigationItem[],
        parent: GammaNavigationItem[] | GammaNavigationItem
    ): GammaNavigationItem[] | GammaNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
