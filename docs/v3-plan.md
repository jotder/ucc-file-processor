...
formats — as **v3.10.0**; the plugin-SPI unification — single `StreamingFileIngester` SPI with
size-routed union/generation modes + DuckDB Appender ingest (breaking removal of `FileIngester`) —
