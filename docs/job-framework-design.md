...
>
> **Status: IN BUILD — P0 + P1(reachable) SHIPPED (2026-07-09; §17): registry + `run(JobContext)` bridge
> + Run Log (P0), signal ledger (P1a), on-signal triggers + `when` + composition (P1c). Open questions
> resolved (§19). Next: P2 Job Packs — which carries the deferred, consumer-gated P1b (parameters) and
> P1d (Run Artifacts), since those go live with their first param-declaring / artifact-producing type.**
