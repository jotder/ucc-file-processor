...
>
> **Status: IN BUILD — P0 + P1(reachable) + P2 + P3a + P3a-2 + P1d + P3b SHIPPED (2026-07-09; §17): registry +
...
> Open questions resolved (§19). Next in P3: the descriptor-driven authoring UI (P3c).**
