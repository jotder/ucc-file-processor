...
>
> **Status: IN BUILD — P0 + P1(reachable) + P2 + P3a + P3a-2 + P1d SHIPPED (2026-07-09; §17): registry +
...
> `$signal.<field>` completing the §7.2 ladder (P3a-2), Run Artifacts + `$upstream` (P1d). Open
> questions resolved (§19). Next in P3: the `sql.template` Job Type (P3b — first real artifact producer)
> and the descriptor-driven authoring UI (P3c).**
