...
| **1 — Builder: Workbench** | Connections + connection-workbench (247L) · Sources · **Pipelines editor (752L — decompose: palette / canvas / inspector / state machine to lib)** · parser-config dialog (first big SchemaForm conversion, 9 parser kinds) · node-config · Enrichment · Jobs + job-form (330L/222L) | heaviest UX debt, biggest forms, proves W1+W2 end-to-end |
