...
| **2 — Builder: Studio** + W4 lens shell | **Dataset editor — ✅ reviewed 2026-07-02** (dup-guard; SchemaForm conversion evaluated + deferred, `reviews/dataset-editor.md`) · **Widget-options — ✅ converted 2026-07-02** (first Studio SchemaForm conversion; shared renderer gained an always-visible-optional tier, `reviews/widget-options.md`) · **Widgets/Explore — ✅ reviewed 2026-07-02** (`reviews/widgets-explore.md`) · **Dashboards editor — ✅ reviewed 2026-07-02** (`reviews/dashboard-editor.md`) · Components/Registry · Catalog + lineage graph · Assist — **remaining** | second authoring cluster; converts widget-options/dataset editors to SchemaForm; lens switcher (W4) still not built — deferred with the remaining panes |
