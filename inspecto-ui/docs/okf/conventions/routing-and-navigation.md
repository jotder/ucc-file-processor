...
* **Nav groups** (4 collapsable): **Pipelines** · **Acquisition** · **Operations** · **Settings**, plus Dashboard + Assistant basics. See the [features index](../features) for the screen-to-group mapping.
* **Detail pages carry a breadcrumb** (list → id), e.g. [pipeline-detail](../features/pipeline-detail.md).
