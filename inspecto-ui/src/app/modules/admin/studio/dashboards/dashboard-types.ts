...
/**
 * Studio **Dashboard** model — a composite of saved charts laid out in a grid, with an optional dashboard-level
 ...
 * in component-model terms. Mirrors `chart-types.ts`.
 */

/** One placed tile: which saved chart + how wide (1 or 2 grid columns). Order in the array = layout order. */
...
/** Build a {@link Dashboard} from a name + tiles/filter (mirrors `buildChart`). */
