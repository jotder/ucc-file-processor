...
export type ComponentType = 'grammar' | 'schema' | 'transform' | 'sink' | 'rule' | 'dataset' | 'query' | 'widget' | 'dashboard' | 'requirement' | 'reconciliation' | 'link-analysis-view' | 'geo-map-view';
