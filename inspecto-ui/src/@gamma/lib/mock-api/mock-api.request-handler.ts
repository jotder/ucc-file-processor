...
import { GammaMockApiReplyCallback } from '@gamma/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class GammaMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: GammaMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: GammaMockApiReplyCallback): void {
        // Store the reply
