...
@Component({
    selector: 'gamma-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => GammaVerticalNavigationCollapsableItemComponent),
...
export class GammaVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'gamma-vertical-navigation-item-collapsed': this.isCollapsed,
            'gamma-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._gammaVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._gammaVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._gammaVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._gammaVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
