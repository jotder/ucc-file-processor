            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `gamma.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `gamma.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--gamma-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--gamma-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
