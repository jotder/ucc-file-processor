...
import {
    GammaAnimationCurves,
    GammaAnimationDurations,
} from '@gamma/animations/defaults';
...
const fadeIn = trigger('fadeIn', [
    ...
    transition('void => *', animate('{{timings}}'), {
        params: {
            timings: `${GammaAnimationDurations.entering} ${GammaAnimationCurves.deceleration}`,
        },
    }),
]);
...
const fadeOut = trigger('fadeOut', [
    ...
    transition('* => void', animate('{{timings}}'), {
        params: {
            timings: `${GammaAnimationDurations.exiting} ${GammaAnimationCurves.acceleration}`,
        },
    }),
]);
