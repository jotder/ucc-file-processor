...
import { GammaMockApiUtils } from '@gamma/lib/mock-api/mock-api.utils';
import {
    tags as tagsData,
    tasks as tasksData,
    ...
    registerHandlers(): void {
        ...
        this._gammaMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = GammaMockApiUtils.guid();
        ...
        // @ Tasks - GET
        // -----------------------------------------------------------------------------------------------------
        this._gammaMockApiService.onGet('api/apps/tasks/all').reply(() => {
            // Clone the tasks
