...
/**
 * Thrown by a {@link SourceConnector} when discovery, retrieval, or finalization fails.
 *
 * <p>Extends {@link IOException} so it flows transparently through the engine's existing
 * {@code throws IOException} contracts (e.g. {@link com.gamma.inspector.SourceProcessor#collectCandidates})
