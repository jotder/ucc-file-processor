...
/**
 * One typed node in a {@link PipelineGraph}. A node is a thin declaration: its {@code type} names
...
public record PipelineNode(String id, String type, String name, String description,
    ...
    public PipelineNode(String id, String type, Map<String, Object> config, String use) {
        this(id, type, null, null, config, use);
    }

    /** A node with config but no registry reference. */
    public static PipelineNode of(String id, String type, Map<String, Object> config) {
        return new PipelineNode(id, type, null, null, config, null);
    }

    /** A bare node — no config, no registry reference. */
    public static PipelineNode of(String id, String type) {
        return new PipelineNode(id, type, null, null, Map.of(), null);
    }
