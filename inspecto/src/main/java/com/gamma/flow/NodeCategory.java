...
/**
 * The coarse <b>family</b> a {@link FlowNodeType} belongs to. Two uses: it groups node types in the UI
 * palette (doc §6), and it lets the engine reason about a node's <em>role</em> without string-matching
 * the {@code type} discriminator — e.g. {@link FlowStores} treats every {@link #SINK} node as a store
